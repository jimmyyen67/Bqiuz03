...
<div class="tab rb" style="width:87%;">
  <div style="background:#FFF; width:100%; color:#333; text-align:left">
    <video src="image/<?= $row['trailer']; ?>" width="300px" height="250px" controls="true" style="float:right;" autoplay="true"></video>
    <font style="font-size:24px"> <img src="image/<?= $row['poster']; ?>" width="200px" height="250px" style="margin:10px; float:left">
      ...
      <br>
      <br>
      <p style="margin:10px 3px 3px 3px; word-break:break-all"> 劇情簡介：<br><?= $row['introduce']; ?>
      </p>
    </font>
